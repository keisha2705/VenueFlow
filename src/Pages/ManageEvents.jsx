            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  type="number"
                  value={ticketSales}
                  onChange={(event) => setTicketSales(event.target.value)}
                  required
                />
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="https://example.com/j-act.jpg"
                  required
                />
              </div>
            </div>
                  ...
                  <div className="event-card" key={event._id}>
                    <div className="event-card-content">
                      ...
                      <div className="event-details">
                        ...
                        <p>
                          <strong>Ticket Sales Closing Date:</strong>
                        ...
                        <p>
                          ...
                          {venue ? venue.address : "Address not found"}
                        </p>
                        <p>
                          <strong>Capacity:</strong>
                          {venue ? venue.capacity : "Capacity not found"}
                        </p>
                      </div>
